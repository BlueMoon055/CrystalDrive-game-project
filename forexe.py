...
while True:
    ...
    while menu:
        ...
        record_text = record_font.render(f"МОЙ РЕКОРД КРИСТАЛЛОВ: {best}", True, (255, 255, 255))
        win.blit(record_text, (70, 150))
        pygame.display.flip()
        clock.tick(60)
    ...
    while True:
        ...
        win.blit(f.render(f"СЧЁТ КРИСТАЛЛОВ: {score}", 1, (255, 255, 255)), (10, 10))
